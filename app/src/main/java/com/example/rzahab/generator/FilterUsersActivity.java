...
public class FilterUsersActivity extends AppCompatActivity implements Serializable {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (users_suggested.size() > 0) {
                    ...
                    Intent i = new Intent(FilterUsersActivity.this, ListSuggestedActivity.class);
                    gender_filter = (gender_filter != null ) ? gender_filter : "Any";
                    dob_filter = (dob_filter != null ) ? dob_filter : "Any";
                    i.putExtra("gender", gender_filter);
                    i.putExtra("dob", dob_filter);
                    startActivity(i);
                    finish();
                } else {
                    Toast.makeText(FilterUsersActivity.this, R.string.non_found, Toast.LENGTH_LONG).show();
                    addNew();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_home:
                startActivity(new Intent(this, FilterUsersActivity.class));
                finish();
                break;
